...
class WindowCovering extends require('../gpioAccessory.js').GPIOAccessory {
    ...
    loadConfiguration() {
        ...
        this.timeUp = this.config.timeUp;
        this.timeDown = this.config.timeDown;
    }
    ...
    initService() {
        ...
        new (require('../gpioCharacteristics.js')).GpioSwitch(this.log, this.engineDown, this.pinDown, this.invertHighLowDown);
