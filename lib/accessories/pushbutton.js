...
class PushButton extends require('../gpio_accessory.js').GPIOAccessory {
    ...
    initService() {
        ...
        new (require("../gpio_actuator.js")).GpioOutput(this.log, this.hap.characteristicOn, this.pin, this.invertHighLow, this.onChangeCharacteristicOn.bind(this));
    }
