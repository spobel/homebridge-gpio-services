...
class Valve extends require('../gpioAccessory.js').GPIOAccessory {
    ...
    initService() {
        ...
        new (require("../gpioCharacteristics.js")).GpioSwitch(this.log, this.hap.active, this.pin, this.invertHighLow, this.onChangeActive.bind(this));
