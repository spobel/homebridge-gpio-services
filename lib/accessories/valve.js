...
class Valve extends require('../gpio_accessory.js').GPIOAccessory {
    ...
    initService() {
        ...
        new (require("../gpio_actuator.js")).GpioOutput(this.log, this.hap.active, this.pin, this.invertHighLow, this.onChangeActive.bind(this));
