...
class MotorizedOpenClose extends require('../gpio_accessory.js').GPIOAccessory {
    ...
    initService() {
        ...
        new (require('../gpio_actuator.js')).GpioOutput(this.log, this.engineStop, this.pin, this.invertHighLow, this.onChangeEngineStop.bind(this));

        this.engineUp = new Service.Switch(this.name + "engineOpen").getCharacteristic(Characteristic.On);
        new (require('../gpio_actuator.js')).GpioOutput(this.log, this.engineUp, this.pinOpen, this.invertHighLowOpen, this.onChangeEngineOpen.bind(this));

        this.engineDown = new Service.Switch(this.name + "engineClose").getCharacteristic(Characteristic.On);
        new (require('../gpio_actuator.js')).GpioOutput(this.log, this.engineDown, this.pinClose, this.invertHighLowClose, this.onChangeEngineClose.bind(this));
        ...
        if (this.pinContactOpen !== undefined) {
            ...
            new (require('../gpio_actuator.js')).GpioInput(this.log, this.contactOpen, this.pinContactOpen, this.invertHighLowContactOpen, this.onChangeContactOpen.bind(this));
        }
        ...
        if (this.pinContactClose !== undefined) {
            ...
            new (require('../gpio_actuator.js')).GpioInput(this.log, this.contactClose, this.pinContactClose, this.invertHighLowContactClose, this.onChangeContactClose.bind(this));
        }
    }
